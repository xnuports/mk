# $Id: meta.autodep.mk,v 1.76 2026/08/04 16:45:57 sjg Exp $
#
...
.if ${_DEPENDFILE:T:Mlocal.*} != ""
# we are bootstrapping and have
# .MAKE.DEPENDFILE = local.dirdeps-missing.mk
_DEPENDFILE := ${_CURDIR}/${.MAKE.DEPENDFILE_DEFAULT:T}
.endif
.if !exists(${_DEPENDFILE})
